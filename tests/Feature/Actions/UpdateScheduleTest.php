...
class UpdateScheduleTest extends TestCase
{
    ...
    public function test_throws_exception_if_no_schedule_data_is_provided()
    {
    ...
    public function test_throws_exception_if_location_is_not_provided_and_resource_has_no_location()
    {
        $this->expectException(Exception::class);
    ...
    public function test_creates_and_formats_new_schedule_records()
    {
        // Arrange
        $resource = Resource::factory()->create();
    ...
    public function test_deletes_existing_schedules_and_replaces_with_new_ones()
    {
        // Arrange
        $resource = Resource::factory()->create();
        $location = Location::factory()->create();
    ...
    public function test_throws_exception_if_invalid_day_is_provided_in_schedule_data()
    {
        $this->expectException(Exception::class);
    ...
    public function test_throws_exception_if_start_or_end_time_is_missing_in_schedule()
    {
        $this->expectException(Exception::class);
